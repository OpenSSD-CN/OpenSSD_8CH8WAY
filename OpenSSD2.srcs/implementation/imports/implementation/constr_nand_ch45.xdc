...
set_input_delay -add_delay -clock [get_clocks CH4_DQSFromNAND_Clock] -min 5 [get_ports {IO_NAND_CH4_DQ[*]}]
set_input_delay -add_delay -clock [get_clocks CH4_DQSFromNAND_Clock] -clock_fall -min 5 [get_ports {IO_NAND_CH4_DQ[*]}]
# (end)
...
set_input_delay -add_delay -clock [get_clocks CH5_DQSFromNAND_Clock] -min 5 [get_ports {IO_NAND_CH5_DQ[*]}]
set_input_delay -add_delay -clock [get_clocks CH5_DQSFromNAND_Clock] -clock_fall -min 5 [get_ports {IO_NAND_CH5_DQ[*]}]
# (end)
