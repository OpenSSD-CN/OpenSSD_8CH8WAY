...
set_input_delay -add_delay -clock [get_clocks CH6_DQSFromNAND_Clock] -min 5 [get_ports {IO_NAND_CH6_DQ[*]}]
set_input_delay -add_delay -clock [get_clocks CH6_DQSFromNAND_Clock] -clock_fall -min 5 [get_ports {IO_NAND_CH6_DQ[*]}]
# (end)
